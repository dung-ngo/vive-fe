...
import { GetBanCanBietQuery } from '@/lib/gql/graphql';
import { useRouter } from 'next/router';
import useTranslations from '@/hooks/useTranslations';

const VeganInfoScreen = ({
  banCanBiet,
}: {
  banCanBiet: GetBanCanBietQuery;
}) => {
  ...
  return (
    <div className="vive-info-screen">
          ...
          {listReasons[6] && (
            <article className="start-vegan">
              ...
              <div>
                ...
                <div className="box-btn-join-us">
                  <PrimaryButton
                    onClick={() =>
                      router.push(listReasons[6]?.hyperlink || '#')
                    }
                  >
                    {t.nutThamGiaNgay}
                  </PrimaryButton>
...
export default VeganInfoScreen;
