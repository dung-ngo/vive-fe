          ...
          <div className="signature-count text-center">
            <p className="text-body">
              <span className="font-bold">
                15,000 người đã ký đơn thỉnh cầu.
              </span>{' '}
          ...
          <div className="featured-comment">
            ...
            <div className="flex gap-3 mb-5">
              ...
              <div className="bg-gray-200 p-3 rounded-3xl">
                ...
                <p className="text-sm">
                  Tôi hoàn toàn ủng hộ việc chấm dứt lễ hội giết mổ lợn tàn bạo
                  này. Chúng ta phải đối xử với động vật một cách nhân đạo.
                </p>
              </div>
            </div>
        ...
        <div className="petition-content-container">
          ...
          <div className="petition-content-1">
            <p style={{ marginBottom: '2rem' }}>
              ...
              frightening, loud music. Their throats are then slit while they're
              still fully conscious so that villagers can dip money in their
              blood for "good luck."
            </p>
            <p>
              Pigs are social, playful, protective animals who bond with each
              other, make nests, and relax in the sun. They are known to dream,
              recognize their own names, learn "tricks" like sitting for a
              treat, lead social lives of a complexity previously observed only
              in primates, and have been seen showing empathy for other pigs who
              are unhappy or distressed. All pigs deserve long, happy lives,
